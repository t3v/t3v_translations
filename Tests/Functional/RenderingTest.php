<?php
namespace T3v\T3vTranslations\Tests\Functional;
 ...
 *
 * @package T3v\T3vTranslations\Tests\Functional
 */
class RenderingTest extends FunctionalTestCase {
   ...
   * @var array
   */
  protected $testExtensionsToLoad = ['typo3conf/ext/t3v_translations'];
  ...
  public function templateIsRendered() {
    ...
    $expectedDom->loadHTML('<h1>T3v Translations</h1>');
  ...
  protected function setUp() {
    ...
    $this->setUpFrontendRootPage(1, ['EXT:t3v_translations/Tests/Functional/Fixtures/Frontend/Basic.typoscript']);
  }
